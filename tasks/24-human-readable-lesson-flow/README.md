...
- `planned` - [workstreams/02-lesson-header-compression.md](C:/Users/Andr3y/projects/javascript_projects/brain-gainz/tasks/24-human-readable-lesson-flow/workstreams/02-lesson-header-compression.md)
