...
Даже после pixel-полировки `Карта` всё ещё воспринималась как screen with sections. Нужен был более жёсткий workspace layout:
- summary bar сверху
...
- приведение композиции к референсу, но с учётом реального BrainGainz workflow
